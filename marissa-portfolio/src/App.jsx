    ...
    <div className="min-h-screen bg-gradient-to-b from-[#05060a] via-[#081028] to-[#071021] text-slate-100 antialiased">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
          ...
          <div className="md:col-span-7">
            <div>
              ...
              <div className="mt-8 flex gap-4">
                <a href="#projects" className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-r from-indigo-500 to-pink-500 text-black font-semibold shadow-lg hover:scale-[1.02] transition">
                  View My Work
                </a>
        ...
        <section className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Web Dev Column */}
          <div id="webdev" className="p-6 rounded-2xl bg-gradient-to-br from-white/3 to-white/5 border border-white/10 backdrop-blur-sm">
          ...
          {/* Tutoring Column */}
          <div id="tutoring" className="p-6 rounded-2xl bg-gradient-to-br from-white/3 to-white/5 border border-white/10 backdrop-blur-sm">
            <div className="flex items-start gap-4">
        ...
        <section id="projects" className="mt-14">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            {projects.map((p, i) => (
              <div key={i} className="p-6 rounded-2xl bg-gradient-to-br from-white/3 to-white/5 border border-white/8 backdrop-blur-sm hover:scale-[1.01] transition">
        ...
        <section className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-white/3 to-white/5 border border-white/8 backdrop-blur-sm">
        ...
        <section className="mt-14">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            {testimonials.map((t, i) => (
              <blockquote key={i} className="p-6 rounded-2xl bg-white/3 backdrop-blur-sm border border-white/8">
